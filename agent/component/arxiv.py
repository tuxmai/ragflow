...
class ArXiv(ComponentBase, ABC):
    ...
    def _run(self, history, **kwargs):
        ...
        try:
            ...
            search = arxiv.Search(query=ans, max_results=self._param.top_n, sort_by=sort_choices[self._param.sort_by])
            arxiv_res = [{"content": "Title: " + i.title + '\nPdf_Url: <a href="' + i.pdf_url + '"></a> \nSummary: ' + i.summary} for i in list(arxiv_client.results(search))]
