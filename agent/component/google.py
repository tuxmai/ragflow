...
class Google(ComponentBase, ABC):
    ...
    def _run(self, history, **kwargs):
        ...
        try:
            client = GoogleSearch({"engine": "google", "q": ans, "api_key": self._param.api_key, "gl": self._param.country, "hl": self._param.language, "num": self._param.top_n})
            google_res = [{"content": '<a href="' + i["link"] + '">' + i["title"] + "</a>    " + i["snippet"]} for i in client.get_dict()["organic_results"]]
        except Exception:
