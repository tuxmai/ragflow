...
class TableStructureRecognizer(Recognizer):
    ...
    def __init__(self):
        try:
            ...
            super().__init__(self.labels, "tsr", snapshot_download(repo_id="InfiniFlow/deepdoc", local_dir=os.path.join(get_project_base_directory(), "rag/res/deepdoc"), local_dir_use_symlinks=False))
    ...
    def __call__(self, images, thr=0.2):
        ...
        for tbl in tbls:
            lts = [{"label": b["type"], "score": b["score"], "x0": b["bbox"][0], "x1": b["bbox"][2], "top": b["bbox"][1], "bottom": b["bbox"][-1]} for b in tbl]
            if not lts:
                continue
